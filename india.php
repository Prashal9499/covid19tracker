           ...
           <br> <!-- ----------------- line break ----------------- -->
            <br> <!-- ----------------- line break ----------------- -->
              ...
              <section class="corona_update container-fluid"> <!-- ----------------- head line ----------------- -->
                <div class="mb-3 ">
                  <h1 class="text-center text-uppercase h1"> covid-19 india live updates</h1>
                </div>
                  <br> <!-- ----------------- line break ----------------- -->
                    <br> <!-- ----------------- line break ----------------- -->

                      <div style="background-color: #121212" class="table-responsive card"> <!-- ----------------- table head ----------------- -->
                        <table class="table table-dark table-borderless text-left table-hover" style="background-color: #1F1B24" id="tbvalb">
                          <tr>
                            <th style="color: #BB86FC" onclick="sortTable(0)">last Updated Time</th>
                              <th style="color: #BB86FC" onclick="sortTable(1)">State</th>
                                <th style="color: #BB86FC" onclick="sortTable(2)">Confirmed</th>
                                  <th style="color: #BB86FC" onclick="sortTable(3)">Active</th>
                                    <th style="color: #BB86FC" onclick="sortTable(4)">Recovered</th>
                                      <th style="color: #BB86FC" onclick="sortTable(5)">Deaths</th>
                          </tr>   

<?php // ----------------- php for fetching data from API (India) ----------------- 
...
<script> // ----------------- javascript for table sorting -----------------
