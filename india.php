...
<body onload="fetch()"> 
  ...
  <section class="corona_update container-fluid"> 
    <div class="mb-3 ">
      <h1 class="text-center text-uppercase h1 margin"> covid-19 india live updates</h1>
    </div>
    ...
    <div style="background-color: #121212" class="table-responsive card">
      <table class="table table-dark table-borderless text-left table-hover" style="background-color: #1F1B24" id="tbvalb">
        <tr>
          <th style="color: #F39C12" onclick="sortTable(0)">last Updated Time</th>
          <th style="color: #3498DB " onclick="sortTable(1)">State</th>
          <th style="color: #E74C3C" onclick="sortTable(2)">Confirmed</th>
          <th style="color: #C0392B" onclick="sortTable(3)">Active</th>
          <th style="color: #2ECC71" onclick="sortTable(4)">Recovered</th>
          <th style="color: #95A5A6" onclick="sortTable(5)">Deaths</th>
        </tr>   
