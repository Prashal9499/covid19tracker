  ...
  <html>
    ...
    <head> <!-- ----------------- head section ----------------- -->
      ...
      <body onload="fetch()"> <!-- ----------------- body section ----------------- -->
        ...
        <nav class="navbar navbar-expand-lg navbar navbar-dark p-3"> <!-- ----------------- top nav ----------------- -->
          ...
          <br> <!-- ----------------- line break ----------------- -->
            <br> <!-- ----------------- line break ----------------- -->
              ...
              <section class="corona_update container-fluid"> <!-- ----------------- head line ----------------- -->
                <div class="mb-3 ">
                  <h1 class="text-center text-uppercase h1"> covid-19 india testing</h1>
                </div>
                  <br> <!-- ----------------- line break ----------------- -->
                    <br> <!-- ----------------- line break ----------------- -->
                        ...
                        <table class=" table table-dark table-borderless text-left table-hover" style="background-color: #1F1B24;" id="tbvalb">
                          <tr> <!-- ----------------- tabe head ----------------- -->
                            <th style="color: #BB86FC" onclick="sortTable(0)">Date</th>
                              <th style="color: #BB86FC" onclick="sortTable(2)">State</th>
                                <th style="color: #BB86FC">Total Tested</th>
                                  <th style="color: #BB86FC">Positive</th>
                                    <th style="color: #BB86FC">Negative</th>
                          </tr>   

<?php // ----------------- php for fetching data from API (India Testing) ----------------- 
