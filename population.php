...
<body onload="fetch()">
  ...
  <section class="corona_update container-fluid">
    <div class="mb-3 ">
      <h1 class="text-center text-uppercase h1 margin"> covid-19 district-wise population</h1>
    </div>
    ...
    <div style="background-color: #121212" class="table-responsive card">
      <table class=" table table-dark table-borderless text-left table-hover" style="background-color: #1F1B24;" id="tbvalb">
        <tr>
          <th style="color: #3498DB" onclick="sortTable(0)">State</th>
          <th style="color: #FA8072" onclick="sortTable(2)">District</th>
          <th style="color: #16A085" onclick="sortTable(2)">Population</th>
        </tr>   
