                ...
                <div class="mb-3 ">
                  ...
                  <br> <!-- ----------------- line break ----------------- -->
                    <br> <!-- ----------------- line break ----------------- -->
                      ...
                      <div style="background-color: #121212" class="table-responsive card"> <!-- ----------------- main data table ----------------- -->
...
<script> // ----------------- javascript for fatching data from API (World) -----------------
