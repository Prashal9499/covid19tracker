...
<body onload="fetch()">
  ...
  <section class="container-fluid">
    <div class="mb-3 ">
      <h1 class="text-center text-uppercase main-text margin"> covid-19 world live updates</h1>
    </div>

    <!-- table -->
    <div class="table-responsive">
      <table class=" table table-fixed table-sm table-light text-left table-hover table-striped table-bordered" id="tbvalb">
        <tr>
          <th style="color: #FFFFFF; background-color: #3498DB;" onclick="sortTable(0)">Country</th>
          <th style="color: #FFFFFF; background-color: #E74C3C;" onclick="sortTable(1)">Total Confirmed</th>
          <th style="color: #FFFFFF; background-color: #2ECC71;" onclick="sortTable(2)">Total Recovered</th>
          <th style="color: #FFFFFF; background-color: #95A5A6;" onclick="sortTable(3)">Total Deaths</th>
          <th style="color: #FFFFFF; background-color: #E74C3C;" onclick="sortTable(4)">New Confirmed</th>
          <th style="color: #FFFFFF; background-color: #2ECC71;" onclick="sortTable(5)">New Recovered</th>
          <th style="color: #FFFFFF; background-color: #95A5A6;" onclick="sortTable(6)">New Deaths</th>
        </tr> 
      </table>
    </div>
  </section>
