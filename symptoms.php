...
<body onload="fetch()">
  ...
  <section class="corona_update container-fluid">
    <div class="mb-3 ">
      <h1 class="text-center text-uppercase h1 margin"> Symptoms </h1>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Cough</figcaption> 
          </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Fever</figcaption> 
          </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Sneezing</figcaption> 
          </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Difficulty Breathing</figcaption> 
          </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Tiredness</figcaption> 
          </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
          <figure class ="text-center">
            ...
            <figcaption style="color: #FFFFFF; margin-top: 20px;">Diarrhea</figcaption>
          </figure>
        </div>
      </div>
    </div>
