...
<div class="container icon">
      <div class="row">
          <div class="col-lg-4 col-md-4 col-12 mt-5">
              ...
              <br>
              <br>
              <figcaption style="color: #BB86FC">Cough</figcaption>
              </figure>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-12 mt-5">
              ...
              <br>
              <br>
              <figcaption style="color: #BB86FC">Fever</figcaption>
              </figure>
          </div>
    
          <div class="col-lg-4 col-md-4 col-12 mt-5">
              <figure class ="text-center">
              <img src="images/sneezing.png" class="img-fluid" width="120" height="120">
              <br>
              <br>
              <figcaption style="color: #BB86FC">Sneezing</figcaption>
              </figure>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-12 mt-5">
              ...
              <br>
              <br>
              <figcaption style="color: #BB86FC">Difficulty Breathing</figcaption>
              </figure>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-12 mt-5">
              ...
              <br>
              <br>
              <figcaption style="color: #BB86FC">Tiredness</figcaption>
              </figure>
          </div>

          <div class="col-lg-4 col-md-4 col-12 mt-5">
              <figure class ="text-center">
              <img src="images/diarrhea.png" class="img-fluid" width="120" height="120">
              <br>
              <br>
              <figcaption style="color: #BB86FC">Diarrhea</figcaption>
              </figure>
          </div>
    </div>
</div>
